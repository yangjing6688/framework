...
class XapiBaseCopilotAnomaliesApi(XapiHelper):
    ...
    def xapi_base_get_dfs_recurrence_channel_stats(self, **kwargs):
        ...
        """
            ...
            **Note - The kwargs options are explained in the :param section below.
            ...
            Robot ->
                ...
                get dfs recurrence channel stats    **kwargs
            ...
            Pytest ->
                ...
                xapiBaseCopilotAnomaliesApi = XapiBaseCopilotAnomaliesApi()
                xapiBaseCopilotAnomaliesApi.get_dfs_recurrence_channel_stats(**kwargs)
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.CopilotAnomaliesApi(api_client)
            try:
                api_response = api_instance.get_dfs_recurrence_channel_stats(**kwargs)
                # If the _async is True, we will use the Long Running Operation methods
                if kwargs.get('_async', False):
                    # Get the ID
                    operation_id = self.getLongRunningOperationId(api_response)
    ...
    def xapi_base_get_dfs_recurrence_count_stats(self, **kwargs):
        ...
        """
            ...
            **Note - The kwargs options are explained in the :param section below.
            ...
            Robot ->
                ...
                get dfs recurrence count stats    **kwargs
            ...
            Pytest ->
                ...
                xapiBaseCopilotAnomaliesApi = XapiBaseCopilotAnomaliesApi()
                xapiBaseCopilotAnomaliesApi.get_dfs_recurrence_count_stats(**kwargs)
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.CopilotAnomaliesApi(api_client)
            try:
                api_response = api_instance.get_dfs_recurrence_count_stats(**kwargs)
                # If the _async is True, we will use the Long Running Operation methods
                if kwargs.get('_async', False):
                    # Get the ID
                    operation_id = self.getLongRunningOperationId(api_response)
