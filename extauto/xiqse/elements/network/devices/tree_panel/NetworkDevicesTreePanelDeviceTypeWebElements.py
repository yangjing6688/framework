...
from xiqse.defs.network.devices.tree_panel.NetworkDevicesTreePanelDeviceTypeWebElementsDefinitions import NetworkDevicesTreePanelDeviceTypeWebElementsDefinitions
