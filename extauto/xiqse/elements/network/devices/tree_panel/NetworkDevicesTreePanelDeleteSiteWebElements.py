...
from xiqse.defs.network.devices.tree_panel.NetworkDevicesTreePanelDeleteSiteWebElementsDefinitions import NetworkDevicesTreePanelDeleteSiteWebElementsDefinitions
