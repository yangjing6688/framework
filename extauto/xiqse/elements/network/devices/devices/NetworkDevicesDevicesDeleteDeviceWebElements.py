...
from xiqse.defs.network.devices.devices.NetworkDevicesDevicesDeleteDeviceWebElementsDefinitions import NetworkDevicesDevicesDeleteDeviceWebElementsDefinitions
