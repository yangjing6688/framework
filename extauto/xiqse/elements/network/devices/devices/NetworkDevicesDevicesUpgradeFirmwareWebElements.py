...
from xiqse.defs.network.devices.devices.NetworkDevicesDevicesUpgradeFirmwareWebElementsDefinitions import NetworkDevicesDevicesUpgradeFirmwareWebElementsDefinitions
