...
from xiqse.defs.network.devices.devices.NetworkDevicesDevicesFirmwareSelectionWebElementsDefinitions import NetworkDevicesDevicesFirmwareSelectionWebElementsDefinitions
