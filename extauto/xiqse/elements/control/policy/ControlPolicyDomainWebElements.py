...
from xiqse.defs.control.policy.ControlPolicyDomainWebElementsDefinitions import ControlPolicyDomainWebElementsDefinitions


class ControlPolicyDomainWebElements(ControlPolicyDomainWebElementsDefinitions):
    def __init__(self):
