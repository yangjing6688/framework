...
from xiqse.defs.admin.profiles.cli_credentials.AdminProfilesCLICredentialsAddCredWebElementsDefinitions import AdminProfilesCLICredentialsAddCredWebElementsDefinitions
