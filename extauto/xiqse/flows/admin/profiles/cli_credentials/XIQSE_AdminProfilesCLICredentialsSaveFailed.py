...
from xiqse.elements.admin.profiles.cli_credentials.AdminProfilesCLICredentialsSaveFailedWebElements import AdminProfilesCLICredentialsSaveFailedWebElements


class XIQSE_AdminProfilesCLICredentialsSaveFailed(AdminProfilesCLICredentialsSaveFailedWebElements):
    def __init__(self):
        super().__init__()
        self.utils = Utils()
    ...
    def xiqse_save_failed_dialog_handle_failure(self):
        ...
        error_dlg = self.get_add_cli_credential_save_failed_dialog()
        if error_dlg:
            ...
            if error_hidden == "false":
                ...
                error_msg = self.get_add_cli_credential_save_failed_dialog_message()
                if error_msg:
                ...
                error_ok_btn = self.get_add_cli_credential_save_failed_dialog_ok_button()
                if error_ok_btn:
