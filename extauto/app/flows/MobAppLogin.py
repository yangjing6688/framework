...
class MobAppLogin:
    ...
    def login_user(self, username, password, url="default"):
        ...
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_login_page_button_id())
    ...
    def qa_env(self, url_name):
        ...
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_qa_env_save_button())
    ...
    def entry_mycloud_nw(self):
        self.auto_actions.click(self.mob_login_web_elements.get_my_cloud_network())
    ...
    def tap_device_list(self):
        ...
        time.sleep(10)
        #self.auto_actions.click(self.mob_login_web_elements.top_button())
    ...
    def external_admin(self, network_name):
        ...
        self.utils.print_info("user clicked on My cloud network")
        time.sleep(10)
        self.auto_actions.click(self.mob_login_web_elements.get_menu_item())
        self.utils.print_info("user clicked on menu item")
        time.sleep(3)
        self.auto_actions.click(self.mob_login_web_elements.get_switch_button())
        self.utils.print_info("user clicked on switch option")
        time.sleep(10)
        self.auto_actions.click(self.mob_login_web_elements.get_external())
    ...
    def menu_items(self):
        ...
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_settings_item())
        self.utils.print_info("user is clicked on settings")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_settings_backward_link())
        self.utils.print_info("user is clicked on settings option backward link")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_menu_item())
        self.utils.print_info("user clicked on menu item")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_about_item())
        ...
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.get_about_bw_link())
        self.utils.print_info("user clicked on about backward link")
        time.sleep(2)
        #self.auto_actions.click(self.mob_login_web_elements.get_menu_item())
        #self.utils.print_info("user clicked on menu item")
        #time.sleep(2)
        #self.auto_actions.click(self.mob_login_web_elements.get_menu_item_logout())
        #self.utils.print_info("user clicked on logout option")
        #time.sleep(2)
        #self.auto_actions.click(self.mob_login_web_elements.logout_yes_button())
    ...
    def multi_factor_auth(self, otp):
        ...
        self.auto_actions.click(self.mob_login_web_elements.get_multi_factor_submit_button())
        time.sleep(7)
    ...
    def logout_device(self):
        self.auto_actions.click(self.mob_login_web_elements.logout_from_device())
        self.utils.print_info("User clicked on logout option on device list screen")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.logout_cancel_button())
    ...
    def trouble_logging(self, email, url="default"):
        ...
        #import sys, pdb;
        #pdb.Pdb(stdout=sys.__stdout__).set_trace()
        self.auto_actions.click(self.mob_login_web_elements.trouble_login_device())
        ...
        self.auto_actions.click(self.mob_login_web_elements.reset_password_button())
        self.utils.print_info("User clicked on reset password button")
        self.auto_actions.click(self.mob_login_web_elements.back_to_login())
        self.utils.print_info("user clicked on back to login button")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.trouble_login_device())
        self.utils.print_info("User clicked on trouble login device option")
        time.sleep(2)
        self.auto_actions.click(self.mob_login_web_elements.trouble_login_close_link())
