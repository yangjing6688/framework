...
class XapiBaseUserApi(XapiBase):
    ...
    def xapi_base_create_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.create_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.delete_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_current_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.get_current_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_external_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.get_external_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.get_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_grant_external_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.grant_external_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_external_users_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.list_external_users_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_users_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.list_users_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_revoke_external_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.revoke_external_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_external_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.update_external_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_user_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.UserApi(api_client)
            try:
                api_response = api_instance.update_user_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
