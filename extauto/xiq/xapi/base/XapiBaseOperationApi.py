...
class XapiBaseOperationApi(XapiBase):
    ...
    def xapi_base_cancel_operation_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.OperationApi(api_client)
            try:
                api_response = api_instance.cancel_operation_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_operation_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.OperationApi(api_client)
            try:
                api_response = api_instance.delete_operation_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_operation_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.OperationApi(api_client)
            try:
                api_response = api_instance.get_operation_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
