...
class XapiBaseConfigurationBasicApi(XapiBase):
    ...
    def xapi_base_create_vlan_profile(self, **kwargs):
        ...
        >>> result = thread.get()
            ...
            Robot:
                Library     extauto/xiq/xapi/base/XapiBaseConfigurationBasicApi.py
        
                create vlan profile    **kwargs
            Pytest:
                from extauto.xiq.xapi.base.XapiBaseConfigurationBasicApi import XapiBaseConfigurationBasicApi
