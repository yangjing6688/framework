...
class XapiBaseConfigurationAuthenticationApi(XapiBase):
    ...
    def xapi_base_create_external_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.create_external_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_create_internal_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.create_internal_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_create_ldap_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.create_ldap_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_create_radius_client_object_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.create_radius_client_object_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_create_radius_proxy_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.create_radius_proxy_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_external_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.delete_external_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_internal_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.delete_internal_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_ldap_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.delete_ldap_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_radius_client_object_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.delete_radius_client_object_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_delete_radius_proxy_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.delete_radius_proxy_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_external_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.get_external_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_internal_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.get_internal_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_ldap_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.get_ldap_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_radius_client_object_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.get_radius_client_object_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_get_radius_proxy_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.get_radius_proxy_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_active_directory_servers_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_active_directory_servers_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_captive_web_portals_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_captive_web_portals_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_external_radius_servers_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_external_radius_servers_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_internal_radius_devices_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_internal_radius_devices_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_internal_radius_servers_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_internal_radius_servers_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_ldap_servers_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_ldap_servers_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_radius_client_objects_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_radius_client_objects_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_radius_proxies_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_radius_proxies_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_radius_proxy_devices_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.list_radius_proxy_devices_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_external_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.update_external_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_internal_radius_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.update_internal_radius_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_ldap_server_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.update_ldap_server_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_radius_client_object_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.update_radius_client_object_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_update_radius_proxy_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ConfigurationAuthenticationApi(api_client)
            try:
                api_response = api_instance.update_radius_proxy_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
