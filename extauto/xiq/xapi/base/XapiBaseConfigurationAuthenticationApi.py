...
class XapiBaseConfigurationAuthenticationApi(XapiBase):
    ...
    def xapi_base_create_external_radius_server(self, **kwargs):
        ...
        >>> result = thread.get()
            ...
            Robot:
                Library     extauto/xiq/xapi/base/XapiBaseConfigurationAuthenticationApi.py
        
                create external radius server    **kwargs
            Pytest:
                from extauto.xiq.xapi.base.XapiBaseConfigurationAuthenticationApi import XapiBaseConfigurationAuthenticationApi
