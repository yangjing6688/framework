...
class XapiBaseApplicationApi(XapiBase):
    ...
    def xapi_base_list_application_top_clients_usage_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ApplicationApi(api_client)
            try:
                api_response = api_instance.list_application_top_clients_usage_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_applications_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ApplicationApi(api_client)
            try:
                api_response = api_instance.list_applications_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
    ...
    def xapi_base_list_top_applications_usage_with_http_info(self, **kwargs):
        ...
        with self.extremecloudiq.ApiClient(configuration) as api_client:
            ...
            api_instance = self.extremecloudiq.ApplicationApi(api_client)
            try:
                api_response = api_instance.list_top_applications_usage_with_http_info(**kwargs)
                # If the _async is True, we will use the Long Runnning Operation methods
                if kwargs.get('_async', False):
                    operation_id = self.getLongRunningOperationId(api_response)
                    returnValue = self.getAsyncLongRunningOperation(operation_id)
