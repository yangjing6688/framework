...
class XapiBaseConfigurationUserManagementApi(XapiBase):
    ...
    def xapi_base_add_key_based_pcg_users(self, **kwargs):
        ...
        >>> result = thread.get()
            ...
            Robot:
                Library     extauto/xiq/xapi/base/XapiBaseConfigurationUserManagementApi.py
        
                add key based pcg users    **kwargs
            Pytest:
                from extauto.xiq.xapi.base.XapiBaseConfigurationUserManagementApi import XapiBaseConfigurationUserManagementApi
