class ExtremeGuestOnboardingWebElementsDefs:
    ...
    extreme_guest_onboarding_policy_add_condition_dropdown_value = \
        {
            'XPATH': '//div[contains(@data-automation-tag, "eguest-onboarding-policy-criteria-condition-value")]',
            'wait_for': 5
        }
    ...
    extreme_guest_onboarding_rule_add_network_dropdown = \
        {
            'XPATH': '//div[contains(@data-automation-tag, "eguest-filter-combo-wlan")]//div',
            'wait_for': 5
        }
