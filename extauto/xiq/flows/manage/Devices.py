...
class Devices:
    ...
    def get_device_configuration_audit_status_v2(self, device_serial=None, device_mac=None):
        """
    ...
    def _check_device_update_status_v2(self, device_serial=None, device_mac=None):
        """
