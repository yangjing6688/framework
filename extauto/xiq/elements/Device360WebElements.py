...
class Device360WebElements(Device360WebElementDefs):
    ...
    def get_switch_info_ip_address(self):
        return self.weh.get_element(self.switch_info_ip_address)

    def get_switch_info_mac_address(self):
        return self.weh.get_element(self.switch_info_mac_address)

    def get_switch_info_software_version(self):
        return self.weh.get_element(self.switch_info_software_version)

    def get_switch_info_model(self):
        return self.weh.get_element(self.switch_info_model)

    def get_switch_info_serial(self):
        return self.weh.get_element(self.switch_info_serial)

    def get_switch_info_make(self):
        return self.weh.get_element(self.switch_info_make)

    def get_switch_info_iqagent_version(self):
        return self.weh.get_element(self.switch_info_iqagent_version)

    def get_switch_info_device_policy(self):
        return self.weh.get_element(self.switch_info_device_policy)
