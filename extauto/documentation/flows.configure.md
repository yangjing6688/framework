...
### _class_ extauto.xiq.flows.configure.Users.Users()
Bases: `UsersWebElements`


#### add_user(username, password, user_group)

* Add User in the Configure Menu.


* Flow: Configure –> Users –> User Management –> Users–> Add User
...
* **Returns**
    ...
    1 if user created successfully else -1
