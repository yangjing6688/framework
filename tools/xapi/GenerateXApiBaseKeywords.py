...
class parseXAPI:
    ...
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Geneartion script to take the XAPI SDK and genereated the base class files for the AutoIQ framework')
        ...
        self.templateDict['loginAuthenticationApi'] = 'base_login_function_template.txt'
