...
class PytestConfigHelper():
    def __init__(self, config):
        ...
        try:
            ...
            self.node_count += 1
            self.dut1_cli_type  = config['netelem1']['cli_type']
        ...
        try:
            ...
            self.dut2_cli_type  = config['netelem2']['cli_type']
        ...
        try:
            ...
            self.dut3_cli_type  = config['netelem3']['cli_type']
        ...
        try:
            ...
            self.dut4_cli_type  = config['netelem4']['cli_type']
        ...
        try:
            ...
            self.dut5_cli_type = config['netelem5']['cli_type']
