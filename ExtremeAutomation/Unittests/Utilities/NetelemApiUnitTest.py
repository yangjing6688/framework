from ExtremeAutomation.Unittests.Utilities.ApiUnitTest import ApiUnitTest
...
class CliApiUnitTest(ApiUnitTest):
    def __init__(self, csv_path, agent):
        super(CliApiUnitTest, self).__init__(csv_path, agent)
...
class RestApiUnitTest(ApiUnitTest):
    def __init__(self, csv_path, agent):
        super(RestApiUnitTest, self).__init__(csv_path, agent)
...
class SnmpApiUnitTest(ApiUnitTest):
    def __init__(self, csv_path, agent):
        super(SnmpApiUnitTest, self).__init__(csv_path, agent)
