...
if __name__ == "__main__":
    ...
    GenScript.generate_packet("Ethernet2IpV6Packet", "Ethernet2", "IpV6Packet", packetProtocol, packetFields, "")
    GenScript.generate_packet("Ethernet2IpV6TaggedPacket", "Ethernet2", "IpV6TaggedPacket", packetProtocol,
                              packetFields, "Tagged")
    GenScript.generate_packet("Ethernet2IpV6VlanStackPacket", "Ethernet2", "IpV6VlanStackPacket", packetProtocol,
