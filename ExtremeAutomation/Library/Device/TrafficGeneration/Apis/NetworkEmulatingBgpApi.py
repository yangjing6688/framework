...
class NetworkEmulatingBgpApi(TrafficGenerationApi):
    def __init__(self, device):
        super(NetworkEmulatingBgpApi, self).__init__(device)
...
class NetworkEmulatingBgpConstants(object, metaclass=Singleton):
