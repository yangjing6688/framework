...
class IxiaResetPortApi(ResetPortApi):

    """
    init function
    """
    def __init__(self, device):
        super(IxiaResetPortApi, self).__init__(device)
    ...
    def reset_port(self, argdictionary):
        return super(IxiaResetPortApi, self).reset_port(argdictionary, self.supportedIxiaHltapiCommands)
    ...
    supportedIxiaHltapiCommands = {ResetPortConstants.MODE_CMD, ResetPortConstants.PORT_HANDLE_CMD, ResetPortConstants.PROTOCOL_CMD}
