...
class SpirentPacketInfoApi(PacketInfoApi):

    """
    init function
    """
    def __init__(self, device):
        super(SpirentPacketInfoApi, self).__init__(device)
    ...
    def packet_info(self, argdictionary):
        return super(SpirentPacketInfoApi, self).packet_info(argdictionary, self.supportedSpirentHltapiCommands)
    ...
    supportedSpirentHltapiCommands = {PacketInfoConstants.ACTION_CMD: "6.72",
        PacketInfoConstants.PORT_HANDLE_CMD: "6.72"}
