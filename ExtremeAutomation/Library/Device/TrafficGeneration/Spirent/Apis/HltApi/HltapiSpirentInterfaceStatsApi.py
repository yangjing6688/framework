...
class SpirentInterfaceStatsApi(InterfaceStatsApi):

    """
    init function
    """
    def __init__(self, device):
        super(SpirentInterfaceStatsApi, self).__init__(device)
    ...
    def interface_stats(self, argdictionary):
        return super(SpirentInterfaceStatsApi, self).interface_stats(argdictionary, self.supportedSpirentHltapiCommands)
    ...
    supportedSpirentHltapiCommands = {InterfaceStatsConstants.PORT_HANDLE_CMD}
