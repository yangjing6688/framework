...
## REST
## SNMP
# API Function: rsmlt_verify_edge_support_enabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_edge_support_enabled(device_name)

	Robot API Call: 

		rsmlt_verify_edge_support_enabled  device_name

# API Function: rsmlt_verify_edge_support_disabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_edge_support_disabled(device_name)

	Robot API Call: 

		rsmlt_verify_edge_support_disabled  device_name

# API Function: rsmlt_verify_vlan_interface_enabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_vlan_interface_enabled(device_name, interface)

	Robot API Call: 

		rsmlt_verify_vlan_interface_enabled  device_name  interface

# API Function: rsmlt_verify_vlan_interface_disabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_vlan_interface_disabled(device_name, interface)

	Robot API Call: 

		rsmlt_verify_vlan_interface_disabled  device_name  interface

# API Function: rsmlt_verify_intf_holddown_timer
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_intf_holddown_timer(device_name, interface, timer)

	Robot API Call: 

		rsmlt_verify_intf_holddown_timer  device_name  interface  timer

# API Function: rsmlt_verify_intf_holdup_timer
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_verify_intf_holdup_timer(device_name, interface, timer)

	Robot API Call: 

		rsmlt_verify_intf_holdup_timer  device_name  interface  timer
