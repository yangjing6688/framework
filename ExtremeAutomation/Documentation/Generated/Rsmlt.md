...
# API Function: show_info
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_info(device_name )
...
# API Function: show_edge_support
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_edge_support(device_name )
...
# API Function: show_vrf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_vrf(device_name )
...
# API Function: show_vrfid
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_vrfid(device_name )
...
# API Function: show_local
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_local(device_name )
...
# API Function: show_local_vrf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_local_vrf(device_name )
...
# API Function: show_local_vrfid
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_local_vrfid(device_name )
...
# API Function: show_peer
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_peer(device_name )
...
# API Function: show_peer_vrf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_peer_vrf(device_name )
...
# API Function: show_peer_vrfid
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.rsmlt.rsmlt_show_peer_vrfid(device_name )
