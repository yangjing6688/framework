...
This feature is located in this file: `macsec.yaml` (in this directory: econ-automation-framework/ExtremeAutomation/Apis/NetworkElement/ApiDefinition). If any low level keywords are missing they can be added to this file and the APIs can be generated with the following python script located here: /econ-automation-framework/ExtremeAutomation/Apis/GenerateApisFromDefinitionFiles.py. To execute the script. CD to the repository directory (/econ-automation-framework/ExtremeAutomation/Apis/) and type: `python GenerateApisFromDefinitionFiles.py`

# API Function: enable_ca_port
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_enable_ca_port(device_name )
...
# API Function: disable_ca_port
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_disable_ca_port(device_name )
...
# API Function: create_ca
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_create_ca(device_name, ca_name, key_name, key)
...
# API Function: create_ca_encrypted
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_create_ca_encrypted(device_name, ca_name, key_name, key)
...
# API Function: set_cipher_suite_128
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_cipher_suite_128(device_name )
...
# API Function: set_cipher_suite_256
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_cipher_suite_256(device_name )
...
# API Function: set_confidentiality_offset_0
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_confidentiality_offset_0(device_name )
...
# API Function: set_confidentiality_offset_30
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_confidentiality_offset_30(device_name )
...
# API Function: set_confidentiality_offset_50
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_confidentiality_offset_50(device_name )
...
# API Function: set_hw_mode_half_duplex_mode
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_hw_mode_half_duplex_mode(device_name )
...
# API Function: set_hw_mode_macsec_mode
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_hw_mode_macsec_mode(device_name )
...
# API Function: set_include_sci_enable
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_include_sci_enable(device_name )
...
# API Function: set_include_sci_disable
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_include_sci_disable(device_name )
...
# API Function: set_initialize_ports
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_initialize_ports(device_name )
...
# API Function: set_mka_actor_priority
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_mka_actor_priority(device_name, priority, port)
...
# API Function: set_replay_protect
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_replay_protect(device_name )
...
# API Function: set_replay_protect_disable
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_set_replay_protect_disable(device_name )
...
# API Function: clear_counters_all
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_clear_counters_all(device_name )
...
# API Function: clear_counters_on_port
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_clear_counters_on_port(device_name )
...
# API Function: delete_ca
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_delete_ca(device_name )
...
# API Function: show
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show(device_name )
...
# API Function: show_port
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port(device_name )
...
# API Function: show_port_configuration
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_configuration(device_name )
...
# API Function: show_port_detail
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_detail(device_name )
...
# API Function: show_port_counters
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_counters(device_name )
...
# API Function: show_port_all
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_all(device_name )
...
# API Function: show_port_all_config
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_all_config(device_name )
...
# API Function: show_port_all_detail
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_port_all_detail(device_name )
...
# API Function: show_connectivity_association
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_connectivity_association(device_name )
...
# API Function: show_connectivity_association_all
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.NetworkElementMacsecGenKeywords.macsec_show_connectivity_association_all(device_name )
