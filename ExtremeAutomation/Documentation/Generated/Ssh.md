...
## REST
## SNMP
# API Function: ssh_verify_enabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.ssh.ssh_verify_enabled(device_name)

	Robot API Call: 

		ssh_verify_enabled  device_name

# API Function: ssh_verify_disabled
	Pytest API Call: 

		self.defaultLibrary.apiLowLevelApis.ssh.ssh_verify_disabled(device_name)

	Robot API Call: 

		ssh_verify_disabled  device_name
