...
# API Function: show_system_info
	...
	Robot API Call: 
		...
		dutlearning_show_system_info  device_name  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show sys-info||show software detail||show boot config choice
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show system||show system monitor
...
# API Function: show_stacking_info
	...
	Robot API Call: 
		...
		dutlearning_show_stacking_info  device_name  
...
# API Function: show_stack_info
	...
	Robot API Call: 
		...
		dutlearning_show_stack_info  device_name  
...
# API Function: show_chassis_info
	...
	Robot API Call: 
		...
		dutlearning_show_chassis_info  device_name  
...
# API Function: show_unit_info
	...
	Robot API Call: 
		...
		dutlearning_show_unit_info  device_name  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show temperature || show version || show memory process aaa
...
# API Function: show_port_info
	...
	Robot API Call: 
		...
		dutlearning_show_port_info  device_name  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show port status *.{slot_number}.* || show mac port-string *.{slot_number}.* type self
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show port configuration no-refresh || show switch
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Command`:
		...
		show interfaces gigabitEthernet l1-config||show interfaces gigabitEthernet interface
...
# API Function: show_license_info
	...
	Robot API Call: 
		...
		dutlearning_show_license_info  device_name  
