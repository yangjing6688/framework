...
# API Function: show_cpu_interval
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_interval(device_name )
...
# API Function: show_cpu_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_total_utilization(device_name )
...
# API Function: show_cpu_5_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_5_second_utilization(device_name )
...
# API Function: show_cpu_10_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_10_second_utilization(device_name )
...
# API Function: show_cpu_30_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_30_second_utilization(device_name )
...
# API Function: show_cpu_1_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_1_minute_utilization(device_name )
...
# API Function: show_cpu_5_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_5_minute_utilization(device_name )
...
# API Function: show_cpu_30_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_30_minute_utilization(device_name )
...
# API Function: show_cpu_1_hour_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_1_hour_utilization(device_name )
...
# API Function: show_cpu_max_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_max_utilization(device_name )
...
# API Function: show_cpu_threshold
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_threshold(device_name )
...
# API Function: show_cpu_process_state
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_state(device_name )
...
# API Function: show_cpu_process_5_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_5_second_utilization(device_name )
...
# API Function: show_cpu_process_10_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_10_second_utilization(device_name )
...
# API Function: show_cpu_process_30_second_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_30_second_utilization(device_name )
...
# API Function: show_cpu_process_1_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_1_minute_utilization(device_name )
...
# API Function: show_cpu_process_5_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_5_minute_utilization(device_name )
...
# API Function: show_cpu_process_30_minute_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_30_minute_utilization(device_name )
...
# API Function: show_cpu_process_1_hour_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_1_hour_utilization(device_name )
...
# API Function: show_cpu_process_max_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_max_utilization(device_name )
...
# API Function: show_cpu_process_application_time
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_application_time(device_name )
...
# API Function: show_cpu_process_kernel_time
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_process_kernel_time(device_name )
...
# API Function: show_cpu_current_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_current_total_utilization(device_name )
...
# API Function: show_cpu_5_minute_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_5_minute_total_utilization(device_name )
...
# API Function: show_cpu_highest_5_minute_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_highest_5_minute_total_utilization(device_name )
...
# API Function: show_cpu_5_minute_hi_time_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_cpu_5_minute_hi_time_total_utilization(device_name )
...
# API Function: show_total_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_total_memory(device_name )
...
# API Function: show_free_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_free_memory(device_name )
...
# API Function: show_used_system_service_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_used_system_service_memory(device_name )
...
# API Function: show_used_user_application_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_used_user_application_memory(device_name )
...
# API Function: show_used_memory_for_process
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_used_memory_for_process(device_name )
...
# API Function: show_used_total_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_used_total_memory(device_name )
...
# API Function: show_free_total_memory
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_free_total_memory(device_name )
...
# API Function: show_memory_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_memory_total_utilization(device_name )
...
# API Function: show_memory_5_minute_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_memory_5_minute_total_utilization(device_name )
...
# API Function: show_memory_highest_5_minute_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_memory_highest_5_minute_total_utilization(device_name )
...
# API Function: show_memory_5_minute_hi_time_total_utilization
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_memory_5_minute_hi_time_total_utilization(device_name )
...
# API Function: show_used_fbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_used_fbuf(device_name )
...
# API Function: show_free_fbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_free_fbuf(device_name )
...
# API Function: show_exhausted_fbufs
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_exhausted_fbufs(device_name )
...
# API Function: show_net_stack_system_free_mbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_net_stack_system_free_mbuf(device_name )
...
# API Function: show_net_stack_data_free_mbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_net_stack_data_free_mbuf(device_name )
...
# API Function: show_net_stack_system_used_mbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_net_stack_system_used_mbuf(device_name )
...
# API Function: show_net_stack_data_used_mbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_net_stack_data_used_mbuf(device_name )
...
# API Function: show_net_stack_system_socket_mbuf
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_net_stack_system_socket_mbuf(device_name )
...
# API Function: show_highest_queue_entries_consumed
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_highest_queue_entries_consumed(device_name )
...
# API Function: show_current_queue_entries_consumed
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_current_queue_entries_consumed(device_name )
...
# API Function: show_free_queue_entries
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_free_queue_entries(device_name )
...
# API Function: show_slot
	Pytest API Call: 
		...
		self.defaultLibrary.apiLowLevelApis.hostmonitor.hostmonitor_show_slot(device_name )
