...
class DevicesConstants(ApiConstants):
    def __init__(self):
        ...
        self.VERIFY_DEVICE_ASSETTAG = {"constant": "verify_device_assettag",
                                       "tags": ["PARSE_CLI"],
                                       "link": self.link.verify_device_assettag}
        self.VERIFY_DEVICE_BASEMAC = {"constant": "verify_device_basemac",
                                      "tags": ["PARSE_CLI"],
                                      "link": self.link.verify_device_basemac}
        self.VERIFY_DEVICE_NICKNAME = {"constant": "verify_device_nickname",
                                       "tags": ["PARSE_CLI"],
                                       "link": self.link.verify_device_nickname}
        self.VERIFY_DEVICE_SYSNAME = {"constant": "verify_device_sysname",
                                      "tags": ["PARSE_CLI"],
                                      "link": self.link.verify_device_sysname}
