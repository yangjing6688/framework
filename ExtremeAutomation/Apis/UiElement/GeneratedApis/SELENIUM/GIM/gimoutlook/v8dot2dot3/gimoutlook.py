from ExtremeAutomation.Library.Device.Common.Apis.UiBaseApi import UiBaseApi as GimoutlookBase
# All imports above this line will be removed after generation.
# User imports must be added below.


class Gimoutlook(GimoutlookBase):
    def add_outlook(self, ui_cmd_obj, arg_dict):
        ...
        try:
            return super(Gimoutlook, self).add_outlook(ui_cmd_obj, arg_dict)
