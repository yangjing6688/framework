from ExtremeAutomation.Library.Device.Common.Apis.UiBaseApi import UiBaseApi as DfndrpolicyBase
# All imports above this line will be removed after generation.
# User imports must be added below.


class Dfndrpolicy(DfndrpolicyBase):
    def dfndr_policy_function(self, ui_cmd_obj, arg_dict):
        ...
        try:
            return super(Dfndrpolicy, self).dfndr_policy_function(ui_cmd_obj, arg_dict)
