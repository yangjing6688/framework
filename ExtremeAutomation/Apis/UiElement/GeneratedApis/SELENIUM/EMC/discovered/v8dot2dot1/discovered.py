from ExtremeAutomation.Apis.UiElement.GeneratedApis.SELENIUM.EMC.discovered.v8dot2dot0.discovered import Discovered as \
    DiscoveredBase
...
class Discovered(DiscoveredBase):
    ...
    def discovered_edit_device_vlan_definition_set_vrf(self, ui_cmd_obj, arg_dict):
