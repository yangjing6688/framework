"""
This class outlines all the constants for the provisioners API.
...
Example...
>> print(ProvisionersConstants().<SOME_CONSTANT>)
some_constant
"""
from ExtremeAutomation.Library.Utils.Constants.ApiConstants import ApiConstants


class ProvisionersConstants(ApiConstants):
    def __init__(self):
        super(ProvisionersConstants, self).__init__()
        ...
        self.PRV_LABEL_VALIDATION_WITHOUT_CREDENTIALS = {"constant": "prv_label_validation_without_credentials",
                                                         "tags": ["COMMAND_SELENIUM"],
                                                         "link": self.link.prv_label_validation_without_credentials}
