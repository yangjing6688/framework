"""
This class outlines all the constants for the gimguestusers API.
...
Example...
>> print(GimguestusersConstants().<SOME_CONSTANT>)
some_constant
"""
from ExtremeAutomation.Library.Utils.Constants.ApiConstants import ApiConstants


class GimguestusersConstants(ApiConstants):
    def __init__(self):
        super(GimguestusersConstants, self).__init__()
        ...
        self.GU_ADMIN_GU_FILTERS = {"constant": "gu_admin_gu_filters",
                                    "tags": ["COMMAND_SELENIUM"],
                                    "link": self.link.gu_admin_gu_filters}
        self.GU_CLICK_NAV_BAR = {"constant": "gu_click_nav_bar",
                                 "tags": ["COMMAND_SELENIUM"],
                                 "link": self.link.gu_click_nav_bar}
        self.GU_CREATE_ACCESSIBLE_TO_PROV_OPTIONS = {"constant": "gu_create_accessible_to_prov_options",
                                                     "tags": ["COMMAND_SELENIUM"],
                                                     "link": self.link.gu_create_accessible_to_prov_options}
        ...
        self.GU_ENABLE_OR_DISABLE_DELETE_EXPIRY = {"constant": "gu_enable_or_disable_delete_expiry",
                                                   "tags": ["COMMAND_SELENIUM"],
                                                   "link": self.link.gu_enable_or_disable_delete_expiry}
        ...
        self.GU_NOTIFICATION_CREATE_GU = {"constant": "gu_notification_create_gu",
                                          "tags": ["COMMAND_SELENIUM"],
                                          "link": self.link.gu_notification_create_gu}
        self.GU_NOTIFICATION_EMAIL_SMS_UN_PWD = {"constant": "gu_notification_email_sms_un_pwd",
                                                 "tags": ["COMMAND_SELENIUM"],
                                                 "link": self.link.gu_notification_email_sms_un_pwd}
        self.GU_NOTIFICATION_SS_GU = {"constant": "gu_notification_ss_gu",
                                      "tags": ["COMMAND_SELENIUM"],
                                      "link": self.link.gu_notification_ss_gu}
        self.GU_PRINT = {"constant": "gu_print",
                         "tags": ["COMMAND_SELENIUM"],
                         "link": self.link.gu_print}
        self.GU_RESEND_DETAILS = {"constant": "gu_resend_details",
                                  "tags": ["COMMAND_SELENIUM"],
                                  "link": self.link.gu_resend_details}
        ...
        self.GU_SPONSOR_APPROVAL_FROM_PROVISIONER_LOGIN = {"constant": "gu_sponsor_approval_from_provisioner_login",
                                                           "tags": ["COMMAND_SELENIUM"],
                                                           "link": self.link.gu_sponsor_approval_from_provisioner_login}
        self.GU_SUMMARY_VALIDATION = {"constant": "gu_summary_validation",
                                      "tags": ["COMMAND_SELENIUM"],
                                      "link": self.link.gu_summary_validation}
        self.GU_TABLE_COMPLETE_VALIDATION = {"constant": "gu_table_complete_validation",
                                             "tags": ["COMMAND_SELENIUM"],
                                             "link": self.link.gu_table_complete_validation}
