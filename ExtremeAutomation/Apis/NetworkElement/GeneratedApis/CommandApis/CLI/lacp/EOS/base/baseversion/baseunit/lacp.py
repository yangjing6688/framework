...
class Lacp(DeviceApi, LacpBase):
    ...
    def create_lag(self, arg_dictionary, **kwargs):
        ...
        cmd = "set lacp enable||set lacp aadminkey {0} {1}||set port lacp port {2} aadminkey {3}||set port lacp port {4} enable".format(arg_dictionary['main_lag_port'],
                                                                                                                                        arg_dictionary['key'],
                                                                                                                                        arg_dictionary['port'],
                                                                                                                                        arg_dictionary['key'],
                                                                                                                                        arg_dictionary['port'])
    ...
    def delete_lag(self, arg_dictionary, **kwargs):
        ...
        cmd = "clear lacp aadminkey {0}||set port lacp port {1} disable||clear port lacp port {2} aadminkey||set lacp disable".format(arg_dictionary['main_lag_port'],
                                                                                                                                      arg_dictionary['port'],
                                                                                                                                      arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def set_lag_port(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port lacp port {0} aadminkey {1}||set port lacp port {2} enable".format(arg_dictionary['port'],
                                                                                           arg_dictionary['key'],
                                                                                           arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def clear_lag_port(self, arg_dictionary, **kwargs):
        ...
        cmd = "clear port lacp port {0} aadminkey||set port lacp port {1} disable".format(arg_dictionary['port'],
                                                                                          arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def show_lag(self, arg_dictionary, **kwargs):
        ...
        cmd = "show lacp {0}".format(arg_dictionary['main_lag_port'])
        prompt = "userPrompt"
