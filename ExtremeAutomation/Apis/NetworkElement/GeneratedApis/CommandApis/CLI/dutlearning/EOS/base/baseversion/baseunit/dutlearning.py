...
class Dutlearning(DeviceApi, DutlearningBase):
    ...
    def show_port_info(self, arg_dictionary, **kwargs):
        ...
        cmd = "show port status *.{0}.* || show mac port-string *.{1}.* type self".format(arg_dictionary['slot_number'],
                                                                                          arg_dictionary['slot_number'])
        prompt = "userPrompt"
