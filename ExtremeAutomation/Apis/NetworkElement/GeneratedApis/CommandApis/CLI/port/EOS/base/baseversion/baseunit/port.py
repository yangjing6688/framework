...
class Port(DeviceApi, PortBase):
    ...
    def enable_state(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port enable {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def disable_state(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port disable {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def enable_jumbo(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port jumbo enable {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def disable_jumbo(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port jumbo disable {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def set_speed(self, arg_dictionary, **kwargs):
        ...
        cmd = "set port speed {0} {1}".format(arg_dictionary['port'],
    ...
    def clear_speed(self, arg_dictionary, **kwargs):
        ...
        cmd = "clear port speed {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def show_all_jumbo(self, arg_dictionary, **kwargs):
        ...
        cmd = "show port jumbo {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
    ...
    def show_in_octets(self, arg_dictionary, **kwargs):
        ...
        cmd = "show port counters {0}".format(arg_dictionary['port'])
        prompt = "userPrompt"
