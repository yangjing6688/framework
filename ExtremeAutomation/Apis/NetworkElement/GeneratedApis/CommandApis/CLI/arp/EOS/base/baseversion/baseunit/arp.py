...
class Arp(DeviceApi, ArpBase):
    ...
    def create_entry(self, arg_dictionary, **kwargs):
        ...
        cmd = "arp {0} {1}".format(arg_dictionary['ip_address'],
                                   arg_dictionary['mac'])
    ...
    def create_entry_interface(self, arg_dictionary, **kwargs):
        ...
        cmd = "arp {0} {1} interface vlan.0.{2}".format(arg_dictionary['ip_address'],
                                                        arg_dictionary['mac'],
    ...
    def delete_entry(self, arg_dictionary, **kwargs):
        ...
        cmd = "no arp {0}".format(arg_dictionary['ip_address'])
        prompt = "routerConfigPrompt"
    ...
    def show_entry(self, arg_dictionary, **kwargs):
        ...
        cmd = "show arp {0}".format(arg_dictionary['ip_address'])
        prompt = "userPrompt"
