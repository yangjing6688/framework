...
class SpbmBaseCustomShowTools(BaseShowApi):
    ...
    def check_isis_spbm_multicast_fib_cvlan(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None
    ...
    def check_isis_spbm_ip_unicast_fib_vrf_name(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None
    ...
    def check_isis_spbm_ipv6_unicast_fib_dest_network(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_out_port(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_spbm_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_prefix_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_dest_network(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_nh_beb(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_bvlan(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_out_int_port(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_spbm_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_prefix_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_prefix_type(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_ip_route_pref(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_vrf_name(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_vrf_isid(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ip_unicast_fib_isid_dest_network_isid(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_dest_network(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_nh_beb(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_bvlan(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_out_int_port(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_spbm_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_prefix_cost(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid_vrf_name(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def check_isis_spbm_ipv6_unicast_fib_isid(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None

    def verify_virtual_ist_peer_ip(self, *func_args, **kwargs):
        return self.cmd_obj_constants.METHOD_NOT_SUPPORTED, None
